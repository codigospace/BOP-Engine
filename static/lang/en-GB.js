export function language() {
    var language = {
        ...
        LANG_ADVANCED_INOUT_DIGITAL_WRITE_GET_VAR: 'the value',
        ...
        LANG_MODULAR_DEFINE: 'Declare the module',
        LANG_MODULAR_TYPE: 'of type',
        LANG_MODULAR_PORT: 'on port',
        LANG_MODULAR_READ: 'Read the state of ',
        LANG_MODULAR_WRITE: 'Write to the actuator ',
        LANG_MODULAR_STATE: 'the state',
        LANG_MODULAR_STEPPER_MOTOR: 'Write to the stepper motor',
        LANG_MODULAR_VALUE: 'the value',
        LANG_MODULAR_WRITE_SEVEN_DISPLAY: 'Write to the 7-segment display',
        LANG_MODULAR_FOUR_VALUE: 'Value (4 digits):',
        LANG_MODULAR_SERVO_MOTOR: 'Write to the servo motor',
        LANG_MODULAR_DC_MOTOR: 'Write to the DC motor',
        LANG_MODULAR_DC_MOTOR_POWER: 'the power',
        LANG_MODULAR_DC_MOTOR_DIRECTION: 'and the direction',
        LANG_MODULAR_LCD: 'Write to the screen',
        LANG_MODULAR_LCD_TEXT: 'the text',
        LANG_MODULAR_SENSOR_POTENTIOMETER: 'Potentiometer Sensor',
        LANG_MODULAR_SENSOR_INFRARED: 'Infrared Sensor',
        LANG_MODULAR_SENSOR_BUTTON: 'Button Sensor',
        LANG_MODULAR_SENSOR_DISTANCE: 'Distance Sensor',
        LANG_MODULAR_ACTUATOR_LED: 'LED Actuator',
        LANG_MODULAR_ACTUATOR_BUZZER: 'Buzzer Actuator',
        LANG_MODULAR_ACTUATOR_STEPPER_MOTOR: 'Stepper Motor Actuator',
        LANG_MODULAR_ACTUATOR_DISPLAY_7_SEG: '7-segment Display Actuator',
        LANG_MODULAR_ACTUATOR_SERVO_MOTOR: 'Servo Motor Actuator',
        LANG_MODULAR_ACTUATOR_DC_MOTOR: 'DC Motor Actuator',
        LANG_MODULAR_SENSOR_IMU: 'IMU Sensor',
        LANG_MODULAR_ACTUATOR_LCD: 'LCD Actuator',
        LANG_MODULAR_ACTUATOR_OLED: 'OLED Actuator',
        LANG_MODULAR_MODULE_BLUETOOTH: 'Bluetooth Module',
        LANG_MODULAR_MODULE_WIFI: 'WiFi Module',
        LANG_MODULAR_ON: 'On',
        LANG_MODULAR_OFF: 'Off',
        LANG_MODULAR_FORWARD: 'Forward',
        LANG_MODULAR_BACKWARD: 'Backward',
        // BETTO blocks:
        LANG_CATEGORY_BETTO: 'Betto',
        LANG_BETTO_DEFINE: 'Declare Betto',
        LANG_BETTO_MOVEMENT: 'Movement ',
        LANG_BETTO_VELOCITY: 'with speed',
        LANG_BETTO_DANCE: 'Dance ',
        LANG_BETTO_SIZE: 'size ',
        LANG_BETTO_MOVE: 'Move ',
        LANG_BETTO_GESTURE: 'Gesture ',
        LANG_BETTO_STAND: 'Standing position',
        LANG_BETTO_MOUTH_CLEAN: 'Clear Mouth',
        LANG_BETTO_MOUTH_TEXT: 'Mouth Text',
        LANG_BETTO_MOUTH_GLOW: '👄 Mouth Glow',
        LANG_BETTO_MOUTH: '👄 Mouth',
        LANG_BETTO_ACTION_FORWARD: 'Forward',
        LANG_BETTO_ACTION_BACKWARD: 'Backward',
        LANG_BETTO_ACTION_TURN_LEFT: 'Turn Left',
        LANG_BETTO_ACTION_TURN_RIGHT: 'Turn Right',
        LANG_BETTO_ACTION_TILT_LEFT: 'Tilt Left',
        LANG_BETTO_ACTION_TILT_RIGHT: 'Tilt Right',
        LANG_BETTO_ACTION_SHAKE_LEFT: 'Shake Left',
        LANG_BETTO_ACTION_SHAKE_RIGHT: 'Shake Right',
        LANG_BETTO_ACTION_UP: 'Move Up',
        LANG_BETTO_VELOCITY_NORMAL: 'Normal',
        LANG_BETTO_VELOCITY_SLOW: 'Slow',
        LANG_BETTO_VELOCITY_VERY_SLOW: 'Very Slow',
        LANG_BETTO_VELOCITY_FAST: 'Fast',
        LANG_BETTO_VELOCITY_VERY_FAST: 'Very Fast',
        LANG_BETTO_VELOCITY_TOO_FAST: 'Too Fast',
        LANG_BETTO_DANCE_MOONWALK_LEFT: 'Moonwalk Left',
        LANG_BETTO_DANCE_MOONWALK_RIGHT: 'Moonwalk Right',
        LANG_BETTO_DANCE_CRUSAITO_LEFT: 'Crusaito Left',
        LANG_BETTO_DANCE_CRUSAITO_RIGHT: 'Crusaito Right',
        LANG_BETTO_DANCE_FLAP_UP: 'Flap Up',
        LANG_BETTO_DANCE_FLAP_DOWN: 'Flap Down',
        LANG_BETTO_VELOCITY_NORMAL: 'Normal',
        LANG_BETTO_VELOCITY_SLOW: 'Slow',
        LANG_BETTO_VELOCITY_VERY_SLOW: 'Very Slow',
        LANG_BETTO_VELOCITY_FAST: 'Fast',
        ...
        LANG_BETTO_SIZE_SMALL: 'Small',
        LANG_BETTO_SIZE_LARGE: 'Large',
        LANG_BETTO_DANCE_MENEITO: 'Wiggle',
        LANG_BETTO_DANCE_UP_DOWN: 'Up Down',
        LANG_BETTO_DANCE_TIPTOE_SWAY: 'Tiptoes and Sway',
        LANG_BETTO_DANCE_RESTLESS: 'Restless',
        LANG_BETTO_DANCE_SPIN_ASCENDING: 'Ascending Spin',
        LANG_BETTO_GESTURE_HAPPY: '😃 Happy',
        LANG_BETTO_GESTURE_JOYFUL: '🙂 Joyful',
        LANG_BETTO_GESTURE_SAD: '🙁 Sad',
        LANG_BETTO_GESTURE_SLEEPING: '😴 Sleeping',
        LANG_BETTO_GESTURE_CONFUSED: '😕 Confused',
        LANG_BETTO_GESTURE_FRETUL: '😰 Frightened',
        LANG_BETTO_GESTURE_LOVE: '😍 In Love',
        LANG_BETTO_GESTURE_ANGRY: '😡 Angry',
        LANG_BETTO_GESTURE_MAGIC: '🤩 Magic',
        LANG_BETTO_GESTURE_WAVE: '😐 Wave',
        LANG_BETTO_GESTURE_VICTORY: '😎 Victory',
        LANG_BETTO_GESTURE_FAIL: '😞 Fail',
        LANG_BETTO_GESTURE_FART: '💩 Fart',
        LANG_BETTO_ACTION_HAPPY: 'Happy',
        LANG_BETTO_ACTION_JOYFUL: 'Joyful',
        LANG_BETTO_ACTION_CONTENT: 'Content',
        LANG_BETTO_ACTION_SAD: 'Sad',
        LANG_BETTO_ACTION_CONFUSED: 'Confused',
        LANG_BETTO_ACTION_AFFectionate: 'Caring',
        LANG_BETTO_ACTION_OH: 'Oh',
        LANG_BETTO_ACTION_OOH: 'Oohh',
        LANG_BETTO_ACTION_SURPRISE: 'Surprise',
        LANG_BETTO_ACTION_CONNECTION: 'Connect',
        LANG_BETTO_ACTION_DISCONNECTION: 'Disconnect',
        LANG_BETTO_ACTION_BUTTON: 'Button',
        LANG_BETTO_ACTION_MODE_1: 'Mode 1',
        LANG_BETTO_ACTION_MODE_2: 'Mode 2',
        LANG_BETTO_ACTION_MODE_3: 'Mode 3',
        LANG_BETTO_ACTION_SLEEP: 'Sleep',
        LANG_BETTO_ACTION_FART_1: 'Fart 1',
        LANG_BETTO_ACTION_FART_2: 'Fart 2',
        LANG_BETTO_ACTION_FART_3: 'Fart 3',
        LANG_BETTO_MOUTH_HAPPY: '😃 Happy',
        LANG_BETTO_MOUTH_JOYFUL: '🙂 Joyful',
        LANG_BETTO_MOUTH_SMILE: '😊 Smile',
        LANG_BETTO_MOUTH_SAD: '😦 Sad',
        LANG_BETTO_MOUTH_DEJECTED: '🙁 Dejected',
        LANG_BETTO_MOUTH_SMALL_SURPRISE: '😮 Small Surprise',
        LANG_BETTO_MOUTH_BIG_SURPRISE: '😲 Big Surprise',
        LANG_BETTO_MOUTH_CONFUSED: '😕 Confused',
        LANG_BETTO_MOUTH_TONGUE_OUT: '😛 Tongue Out',
        LANG_BETTO_MOUTH_CULITO: '🙃 Goofy',
        LANG_BETTO_MOUTH_SERIOUS: '😑 Serious',
        LANG_BETTO_MOUTH_DISAPPOINTED: '🙄 Disappointed',
        LANG_BETTO_MOUTH_LOVE: '💖 In Love',
        LANG_BETTO_MOUTH_VAMPIRE: '🦇 Vampire',
        LANG_BETTO_MOUTH_TEETH: '🦇 Teeth',
        LANG_BETTO_MOUTH_NO: '❌ No',
        LANG_BETTO_MOUTH_OK: '✅ OK',
        LANG_BETTO_MOUTH_QUESTION: '❓ Question',
        LANG_BETTO_MOUTH_THUNDER: '⚡ Thunder',        
        // ULTRASOUND - Betto
        LANG_ULTRASOUND_DISTANCE: 'Distance in cm',
        // CARLITTO blocks:
        LANG_CATEGORY_CARLITTO: 'Carlitto',
        LANG_CARLITTO_DEFINE: 'Declare Carlitto',
        LANG_CARLITTO_MOTOR_LEFT: 'Left motor: ',
        LANG_CARLITTO_MOTOR_RIGHT: 'Right motor: ',
        LANG_CARLITTO_POWER_LEFT: 'Left power: ',
        LANG_CARLITTO_POWER_RIGHT: 'Right power: ',
        LANG_CARLITTO_POTENTIOMETER: 'Potentiometer: ',
        LANG_CARLITTO_MOVE_IN: 'Movement in ',
        LANG_CARLITTO_STOP: 'Stop Carlitto',
        //Raspberry
        LANG_CATEGORY_RASPBERRY: 'Raspberry',
        LANG_RASPBERRY_SEND: 'Sent to Raspberry'
    };
    return language;
};