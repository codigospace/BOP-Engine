export function language(){
    var language = {
        ...
        LANG_MODULAR_VALUE: 'el valor',
        LANG_MODULAR_WRITE_SEVEN_DISPLAY: 'Escribir en el display 7 segmentos',
        LANG_MODULAR_FOUR_VALUE: 'Valor (4 digitos):',
        LANG_MODULAR_SERVO_MOTOR: 'Escribir en el servo motor',
        LANG_MODULAR_DC_MOTOR: 'Escribir en el motor de corriente continua',
        LANG_MODULAR_DC_MOTOR_POWER: 'la potencia',
        LANG_MODULAR_DC_MOTOR_DIRECTION: 'y la direccion',
        LANG_MODULAR_LCD: 'Escribir en la pantalla',
        LANG_MODULAR_LCD_TEXT: 'el texto',
        LANG_MODULAR_SENSOR_POTENTIOMETER: 'Sensor Potenciómetro',
        LANG_MODULAR_SENSOR_INFRARED: 'Sensor Infrarrojo',
        LANG_MODULAR_SENSOR_BUTTON: 'Sensor Pulsador',
        LANG_MODULAR_SENSOR_DISTANCE: 'Sensor Distancia',
        LANG_MODULAR_ACTUATOR_LED: 'Actuador LED',
        LANG_MODULAR_ACTUATOR_BUZZER: 'Actuador Zumbador',
        LANG_MODULAR_ACTUATOR_STEPPER_MOTOR: 'Actuador Motor de Pasos',
        LANG_MODULAR_ACTUATOR_DISPLAY_7_SEG: 'Actuador Display 7 segmentos',
        LANG_MODULAR_ACTUATOR_SERVO_MOTOR: 'Actuador Servomotor',
        LANG_MODULAR_ACTUATOR_DC_MOTOR: 'Actuador Motor DC',
        LANG_MODULAR_SENSOR_IMU: 'Sensor IMU',
        LANG_MODULAR_ACTUATOR_LCD: 'Actuador LCD',
        LANG_MODULAR_ACTUATOR_OLED: 'Actuador OLED',
        LANG_MODULAR_MODULE_BLUETOOTH: 'Módulo Bluetooth',
        LANG_MODULAR_MODULE_WIFI: 'Módulo Wifi',
        LANG_MODULAR_ON: 'Encendido',
        LANG_MODULAR_OFF: 'Apagado',
        LANG_MODULAR_FORWARD: 'Adelante',
        LANG_MODULAR_BACKWARD: 'Atrás',
        //BETTO blocks :
        LANG_CATEGORY_BETTO: 'Betto',
        LANG_BETTO_DEFINE: 'Declarar Betto',
        LANG_BETTO_MOVEMENT: 'Movimiento ',
        LANG_BETTO_VELOCITY: 'con velocidad',
        LANG_BETTO_DANCE: 'Bailar ',
        LANG_BETTO_SIZE: 'tamaño ',
        LANG_BETTO_MOVE: 'Mover ',
        LANG_BETTO_GESTURE: 'Gesto ',
        LANG_BETTO_STAND: 'Posicion Parado',
        LANG_BETTO_MOUTH_CLEAN: 'Borrar Boca',
        LANG_BETTO_MOUTH_TEXT: 'Texto de Boca',
        LANG_BETTO_MOUTH_GLOW: '👄 Brillo de Boca',
        LANG_BETTO_MOUTH: '👄 Boca',
        LANG_BETTO_ACTION_FORWARD: 'Adelante',
        LANG_BETTO_ACTION_BACKWARD: 'Atrás',
        LANG_BETTO_ACTION_TURN_LEFT: 'Girar a la izquierda',
        LANG_BETTO_ACTION_TURN_RIGHT: 'Girar a la derecha',
        LANG_BETTO_ACTION_TILT_LEFT: 'Inclinar a la izquierda',
        LANG_BETTO_ACTION_TILT_RIGHT: 'Inclinar a la derecha',
        LANG_BETTO_ACTION_SHAKE_LEFT: 'Agitar para la izquierda',
        LANG_BETTO_ACTION_SHAKE_RIGHT: 'Agitar para la derecha',
        LANG_BETTO_ACTION_UP: 'Sube',
        LANG_BETTO_VELOCITY_NORMAL: 'Normal',
        LANG_BETTO_VELOCITY_SLOW: 'Lento',
        LANG_BETTO_VELOCITY_VERY_SLOW: 'Muy Lento',
        LANG_BETTO_VELOCITY_FAST: 'Rápido',
        LANG_BETTO_VELOCITY_VERY_FAST: 'Muy Rápido',
        LANG_BETTO_VELOCITY_TOO_FAST: 'Demasiado Rápido',
        LANG_BETTO_DANCE_MOONWALK_LEFT: 'Moonwalk Izquierda',
        LANG_BETTO_DANCE_MOONWALK_RIGHT: 'Moonwalk Derecha',
        LANG_BETTO_DANCE_CRUSAITO_LEFT: 'Crusaito Izquierda',
        LANG_BETTO_DANCE_CRUSAITO_RIGHT: 'Crusaito Derecha',
        LANG_BETTO_DANCE_FLAP_UP: 'Aleteo Arriba',
        LANG_BETTO_DANCE_FLAP_DOWN: 'Aleteo Abajo',
        LANG_BETTO_VELOCITY_NORMAL: 'Normal',
        LANG_BETTO_VELOCITY_SLOW: 'Lento',
        LANG_BETTO_VELOCITY_VERY_SLOW: 'Muy Lento',
        LANG_BETTO_VELOCITY_FAST: 'Rápido',
        ...
        LANG_BETTO_SIZE_SMALL: 'Pequeño',
        LANG_BETTO_SIZE_LARGE: 'Grande',
        LANG_BETTO_DANCE_MENEITO: 'Meneito',
        LANG_BETTO_DANCE_UP_DOWN: 'Sube Baja',
        LANG_BETTO_DANCE_TIPTOE_SWAY: 'Puntillas y Meneo',
        LANG_BETTO_DANCE_RESTLESS: 'Inquieto',
        LANG_BETTO_DANCE_SPIN_ASCENDING: 'Giro Ascendente',
        LANG_BETTO_GESTURE_HAPPY: '😃 Feliz',
        LANG_BETTO_GESTURE_JOYFUL: '🙂 Alegre',
        LANG_BETTO_GESTURE_SAD: '🙁 Triste',
        LANG_BETTO_GESTURE_SLEEPING: '😴 Durmiendo',
        LANG_BETTO_GESTURE_CONFUSED: '😕 Confundid@',
        LANG_BETTO_GESTURE_FRETUL: '😰 Asustad@',
        LANG_BETTO_GESTURE_LOVE: '😍 Enamorad@',
        LANG_BETTO_GESTURE_ANGRY: '😡 Enfadad@',
        LANG_BETTO_GESTURE_MAGIC: '🤩 Magia',
        LANG_BETTO_GESTURE_WAVE: '😐 Ola',
        LANG_BETTO_GESTURE_VICTORY: '😎 Victoria',
        LANG_BETTO_GESTURE_FAIL: '😞 Fracaso',
        LANG_BETTO_GESTURE_FART: '💩 Peo',
        LANG_BETTO_ACTION_HAPPY: 'Feliz',
        LANG_BETTO_ACTION_JOYFUL: 'Alegre',
        LANG_BETTO_ACTION_CONTENT: 'Content@',
        LANG_BETTO_ACTION_SAD: 'Triste',
        LANG_BETTO_ACTION_CONFUSED: 'Confundid@',
        LANG_BETTO_ACTION_AFFectionate: 'Cariños@',
        LANG_BETTO_ACTION_OH: 'Oh',
        LANG_BETTO_ACTION_OOH: 'Oohh',
        LANG_BETTO_ACTION_SURPRISE: 'Sorpresa',
        LANG_BETTO_ACTION_CONNECTION: 'Conexion',
        LANG_BETTO_ACTION_DISCONNECTION: 'Desconexion',
        LANG_BETTO_ACTION_BUTTON: 'Boton',
        ...
        LANG_BETTO_ACTION_FART_1: 'Peo 1',
        LANG_BETTO_ACTION_FART_2: 'Peo 2',
        LANG_BETTO_ACTION_FART_3: 'Peo 3',
        LANG_BETTO_MOUTH_HAPPY: '😃 Feliz',
        LANG_BETTO_MOUTH_JOYFUL: '🙂 Alegre',
        LANG_BETTO_MOUTH_SMILE: '😊 Sonrisa',
        LANG_BETTO_MOUTH_SAD: '😦 Triste',
        LANG_BETTO_MOUTH_DEJECTED: '🙁 Decaid@',
        LANG_BETTO_MOUTH_SMALL_SURPRISE: '😮 Asombrad@',
        LANG_BETTO_MOUTH_BIG_SURPRISE: '😲 Sorprendid@',
        LANG_BETTO_MOUTH_CONFUSED: '😕 Confundid@',
        LANG_BETTO_MOUTH_TONGUE_OUT: '😛 Lengua',
        LANG_BETTO_MOUTH_CULITO: '🙃 Tont@ ',
        LANG_BETTO_MOUTH_SERIOUS: '😑 Seri@',
        LANG_BETTO_MOUTH_DISAPPOINTED: '🙄 Decepcionad@',
        LANG_BETTO_MOUTH_LOVE: '💖 Enamorad@',
        LANG_BETTO_MOUTH_VAMPIRE: '🦇 Vampiro',
        LANG_BETTO_MOUTH_TEETH: '🦇 Dientes',
        LANG_BETTO_MOUTH_NO: '❌ No',
        LANG_BETTO_MOUTH_OK: '✅ OK',
        LANG_BETTO_MOUTH_QUESTION: '❓ Interrogacion',
        LANG_BETTO_MOUTH_THUNDER: '⚡ Trueno',
        // ULTRASOUND - Betto
        LANG_ULTRASOUND_DISTANCE: 'Distancia en cm',
        //BETTO blocks :
        LANG_CATEGORY_CARLITTO: 'Carlitto',
        LANG_CARLITTO_DEFINE: 'Declarar Carlitto',
        LANG_CARLITTO_MOTOR_LEFT: 'Motor izquierdo: ',
        LANG_CARLITTO_MOTOR_RIGHT: 'Motor derecho: ',
        LANG_CARLITTO_POWER_LEFT: 'Potencia izquierda: ',
        LANG_CARLITTO_POWER_RIGHT: 'Potencia derecha: ',
        LANG_CARLITTO_POTENTIOMETER: 'Potenciometro: ',
        LANG_CARLITTO_MOVE_IN: 'Movimiento en ',
        LANG_CARLITTO_STOP: 'Detener Carlitto',
        //Raspberry
        LANG_CATEGORY_RASPBERRY: 'Raspberry',
        LANG_RASPBERRY_SEND: 'Enviar a Raspberry'
    };
    return language;
};